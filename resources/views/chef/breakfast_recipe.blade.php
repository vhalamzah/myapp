...
@section('content')
    ...
    <div class="container">
        <ul class="nav nav-pills nav-fill" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" href="{{url('breakfast')}}"  aria-controls="pills-home" aria-selected="true">BREAKFAST</a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href="{{url('lunch')}}"  aria-controls="pills-profile" aria-selected="false">LUNCH</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="custom-headers custom-spacing">
                    <div class="row">
                        <div class="col-6"><h3 class="mb-1">MY APPROVED BREAKFAST RECIPES</h3></div>
                        {{--<div class="col-6 link-align-right"><a href="{{url('add_recipe_break_fast')}}">+New Breakfast Recipe</a></div>--}}
                        <div class="col-6 link-align-right"><a href="{{route('myrecipe',['type'=>'breakfast','level'=>'new'])}}">+New Breakfast Recipe</a>
                        </div>
                    </div>
