...
@section('content')
    ...
    <div class="container">
        <ul class="nav nav-pills nav-fill" id="pills-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link active"  href="{{url('dinner')}}"  aria-controls="pills-contact" aria-selected="true">DINNER</a>
            </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="custom-headers custom-spacing">
                    <div class="row">
                        <div class="col-6"><h3 class="mb-1">MY APPROVED DINNER RECIPES</h3></div>
                        <div class="col-6 link-align-right"><a href="{{route('myrecipe',['type'=>'dinner','level'=>'new'])}}">+New Dinner Recipe</a></div>
                    </div>
